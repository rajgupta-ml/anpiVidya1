    ...
    <>
      ...
      <section className="font-['poppins'] flex flex-col w-[80%] ml-[265px] h-[100vh] " style={{ width: 'calc(100vw - 280px)' }}>
        <div className="h-full ml-[70px] mr-[70px] mt-[50px] flex flex-col gap-6">
          <div className="heading | bg-[#0079BC] text-white font-[poppins] text-[44px] font-bold py-[30px] px-[50px]  rounded-[20px]">Q/A</div>
          ...
          <div className="p-4 rounded-[20px] bg-[#fff]">
            <div className="bg-[#FFF] overflow-y-auto flex flex-col p-[40px] gap-4 max-h-[65vh]">
              ...
              <ReceiveMessage message="I am a highly intelligent question answering bot. If you ask me a question that is rooted in truth, I will give you the answer. If you ask me a question that is nonsense, trickery, or has no clear answer, I will respond with 'Unknown'." />

              {/* SENDING MESSAGE LAYOUT */}
              <SendMessage message=" What is human life expectancy in the United States?" />

              {/* RECEIVING MESSAGE LAYOUT */}
              <ReceiveMessage message="Human life expectancy in the United States is 78 years." />
            ...
            <form className="flex justify-center items-center gap-4 bg-[#fff] py-4 px-8 " onSubmit={handleSubmit}>
              <input onChange={(e) => (setQuestion(e.target.value))} className="bg-[#DBDCDC] h-[5rem] w-full rounded-[20px] px-[30px] text-[28px]" type="text" placeholder="ASK A FACTUAL QUESTION..." />
              <button className="bg-[#FFC100] h-[5rem] px-[30px] rounded-[20px] text-[28px]" type="submit">ASK</button>
            </form>
          </div>
        </div>
