    ...
    <main>
      ...
      <div className="hidden md:flex justify-center">
        ...
        <section className="font-['poppins'] flex flex-col justify-center items-center ml-[250px] h-[100vh]" style={{ width: 'calc(100vw - 280px)' }}>
          ...
          <form action="/submitNote" method="post" className="flex flex-col justify-center items-center p-8 m-8 gap-4 bg-[#0079BC] rounded-[20px]" style={{ width: 'min(100% - 5rem , 510px)', height: 'min(100% - 5rem ,460px' }}>
            ...
            <input className="rounded-[20px] px-4 py-2 w-full" type="text" id="note" name="note" placeholder="Enter topic here" />
            <textarea rows={6} className="rounded-[20px] px-4 py-2 w-full" type="email" placeholder="AI Generated Summary..." />
