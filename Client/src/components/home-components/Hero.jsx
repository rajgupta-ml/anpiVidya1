        ...
        <div className='hero-main-container | max-width-container flex flex-col-reverse'>
            <div className="col1 | text-center mt-4">
                ...
                <div className="cta-arrow-container | ">
                    ...
                    <div>
                        <button className='cta | bg-[#FFC100] min-w-[292.6px] min-h-[89.6px] border-4 text-white text-5xl rotate-[-2.14deg] mt-6 md:mt-0'><NavLink to="/signup">signup</NavLink></button>
                    </div>
                </div>
