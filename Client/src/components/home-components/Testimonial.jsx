                    ...
                    <div className="row1">
                        <div className="row1-test-card test-card | w-[100%] min-h-[8.688rem] max-h[16.25] b border-4 ">
                            <div className="testimonial | border-2  w-[80%] text-xs p-4">
                                ...
                                <p>"I love your system. Apnividya is the most valuable business resource we have EVER purchased. I would be lost without apnividya. I am really satisfied with my apnividya."</p>
                            </div>
                        </div>
