...
function SignupContainer() {
    ...
    return (
        <div>
            <div className="signup-container | flex flex-col justify-center items-center max-width-container mt-24">

                <form className='signup-form | bg-[#0079BC] p-2 max-w-[720px] w-full flex flex-col items-center ' onSubmit={handleSubmit} >
                    ...
                    <div className="input-fields | flex flex-col gap-4 ">
                        ...
                        <div className='relative'>
                            <input values={values.password} onChange={handleChange} onBlur={handleBlur} name="password" type="password" placeholder='Enter your password' className={errors.password ? "signup-input-field | w-full h-[71px] font-[poppins]  px-8 bg-[#F0F5FB] border-4  border-[#E04F5F]  text-black text-[1.25rem] outline-none md:w-[495px]" : "signup-input-field | w-[350px] h-[71px] font-[poppins]  px-8 bg-[#F0F5FB] border-4  border-[#4BAE4F]  text-black text-[1.25rem] outline-none md:w-[495px]"} />
                        ...
                        <div className='relative'>
                            <input values={values.confirmPassword} onChange={handleChange} onBlur={handleBlur} name="confirmPassword" type="password" placeholder='re-enter your password' className={errors.confirmPassword ? "signup-input-field | w-full h-[71px] font-[poppins]  px-8 bg-[#F0F5FB] border-4  border-[#E04F5F]  text-black text-[1.25rem] outline-none md:w-[495px]" : "signup-input-field | w-[350px] h-[71px] font-[poppins]  px-8 bg-[#F0F5FB] border-4  border-[#4BAE4F]  text-black text-[1.25rem] outline-none md:w-[495px]"} />
                            {/* 
                    ...
                    <button type='submit' className='signup-cta | w-full h-[5.375rem] mt-[30px] border-4 border-black outline-none bg-[#FFC100] text-[3.375rem] text-white md:w-[495px]'><h1 className='rotate-[-2.13deg]'>submit</h1></button>
